...
# to compressed ascii files which contains all frames at 25 frames per seconds
#
...
#
# Then to convert video file to asciiart the [img2txt.py](https://github.com/hit9/img2txt) script is used.
#
# Usage:
...
# Command for converting image frame to ascii characters
...
def _convertFrames(files, output_file, max_length):
	'''
	Convert bulk of files to ascii and append to output file
...
def convert(input_file, output_file, frame_rate = 25, max_length = 75):
	'''
	Convert input video file to ascii compressed output file
	...
	:param max_length: maximum length of single line in ascii format
	:return: None
	'''
